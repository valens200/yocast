...
function AnalyticsCards() {
    ...
    return (
        <div className='text-white items-center space-y-6  font-poppins  flex flex-col md:flex-row justify-between md:w-[95%] h-[85vh] mx-auto '>
            {analyticsCards.map((card, index) => (
                <div className={ isDarkMode ? 'flex transition hover:-translate-y-2 delay-100 duration-300 rounded bg-[#212529]  h-[100%] w-[100%] md:w-[24%] p-5  flex-col space-y-3':'flex transition hover:-translate-y-2 delay-100 duration-300 rounded bg-white  h-[100%] w-[24%] p-5 text-[#212529] font-poppins font-sans  flex-col space-y-3'} key={index}>
