...
function Orders() {
  ...
  return (
    <div className='w-[95%] mx-auto flex items-center  md:space-y-0 space-y-8 space-x-3 md:flex-row flex-col md:justify-between h-[100%]'>
      <div className={isDarkMode ? 'md:w-[33%] w-[100%] h-[50vh]  md:h-[57vh]  md:h-[80%]  bg-[#212529]' : ' w-[100%]  md:h-[57vh]   md:w-[30%] h-[50vh] md:h-[80%]   bg-white'}>

      </div>
      <div className={isDarkMode ? 'md:w-[64%]  w-[100%] flex items-center md:h-[57vh]  h-[80%]' : ' w-[100%] md:w-[67%]  flex items-center   bg-white md:h-[57vh] h-[80%]'}>
